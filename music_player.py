...
musicicon=ctk.CTkImage(light_image=Image.open("icons/music.png"),size=(20,20))
iconprev=ctk.CTkImage(light_image=Image.open("icons/previous.png"),size=(20,20))
iconnext=ctk.CTkImage(light_image=Image.open("icons/next.png"),size=(20,20))
iconplay=ctk.CTkImage(light_image=Image.open("icons/play.png"),size=(20,20))
iconstop=ctk.CTkImage(light_image=Image.open("icons/stop.png"),size=(20,20))
iconpause=ctk.CTkImage(light_image=Image.open("icons/pause.png"),size=(20,20))
iconaddv=ctk.CTkImage(light_image=Image.open("icons/add.png"),size=(20,20))
iconminusv=ctk.CTkImage(light_image=Image.open("icons/minus.png"),size=(20,20))
iconspeaker=ctk.CTkImage(light_image=Image.open("icons/speaker.png"),size=(20,20))
iconmute=ctk.CTkImage(light_image=Image.open("icons/mute.png"),size=(20,20))
iconresume=ctk.CTkImage(light_image=Image.open("icons/resume.png"),size=(20,20))
...
lb=ctk.CTkLabel(framesearch,text="Search",text_color=col1,font=("times",12))
